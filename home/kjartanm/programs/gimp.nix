{ pkgs, inputs, ... }: {
  # home.file.".config/GIMP/2.10".source = "${inputs.photoGIMP}/.var/app/org.gimp.GIMP/config/GIMP/2.10";
  home.file.".local/share/applications/org.gimp.GIMP.desktop".text = ''
    [Desktop Entry]
    Version=1.1
    Type=Application
    Name=PhotoGIMP
    ...
    Icon=${inputs.photoGIMP}/.local/share/icons/hicolor/photogimp.png
    Exec=${pkgs.gimp-with-plugins}/bin/gimp
    Actions=
    ...
    Keywords[ar]=GIMP;PhotoGIMP;graphic;design;illustration;painting;
    Keywords[ca]=GIMP;PhotoGIMP;gràfics;disseny;il·lustració;pintura;
    Keywords[ca@valencia]=GIMP;PhotoGIMP;gràfic;disseny;il·lustració;pintura;
    Keywords[cs]=GIMP;PhotoGIMP;grafika;design;ilustrace;malování;
    Keywords[da]=GIMP;PhotoGIMP;grafisk;design;illustration;male;tegne;
    Keywords[de]=GIMP;PhotoGIMP;Grafik;Design;Illustration;Malen;
    Keywords[el]=GIMP;PhotoGIMP;γραφικό;σχεδίαση;επεξήγηση;βαφή;
    Keywords[en_GB]=GIMP;PhotoGIMP;graphic;design;illustration;painting;
    Keywords[es]=GIMP;PhotoGIMP;gráfico;diseño;ilustración;dibujo;
    Keywords[eu]=GIMP;PhotoGIMP;irudia;diseinua;ilustrazioa;margotzea;
    Keywords[fi]=GIMP;PhotoGIMP;grafiikka;maalaus;suunnittelu;valokuva;kuva;
    Keywords[fr]=GIMP;PhotoGIMP;graphisme;conception;design;illustration;image;peinture;
    Keywords[gl]=GIMP;PhotoGIMP;gráfico;deseño;ilustración;debuxo;
    Keywords[hr]=GIMP;PhotoGIMP;grafika;dizajn;ilustracija;slikanje;
    Keywords[hu]=GIMP;PhotoGIMP;grafika;dizájn;tervezés;illusztráció;festés;
    Keywords[is]=GIMP;PhotoGIMP;mynd;hönnun;myndskreyting;málun;myndvinnsla;
    Keywords[it]=GIMP;PhotoGIMP;grafica;design;illustrazioni;disegno;fotoritocco;
    Keywords[lv]=GIMP;PhotoGIMP;grafika;dizains;ilustrācija;glezna;
    Keywords[mr]=गिम्पसाठी;ग्राफिक्स;रचना;उदाहरण;चित्रकला;
    Keywords[nl]=GIMP;PhotoGIMP;grafisch;ontwerp;illustratie;tekenen;
    Keywords[pl]=GIMP;PhotoGIMP;grafika;graficzny;design;dizajn;projektowanie;wzornictwo;ilustracja;ilustrowanie;rysunek;rysowanie;rysownictwo;malowanie;malarstwo;obrazy;obrazki;fotografia;zdjęcia;retuszowanie;renderowanie;wtyczki;
    Keywords[pt]=GIMP;PhotoGIMP;gráficos;design;desenho;ilustração;pintura;
    Keywords[pt_BR]=GIMP;PhotoGIMP;gráficos;design;ilustração;pintura;
    Keywords[ro]=GIMP;PhotoGIMP;graphic;design;illustration;painting;
    Keywords[ru]=GIMP;PhotoGIMP;графика;дизайн;иллюстрация;рисование;
    Keywords[sk]=GIMP;PhotoGIMP;grafika;grafický;návrh;dizajn;ilustrácia;kresba;maľovanie;maľba;
    Keywords[sl]=GIMP;PhotoGIMP;grafika;oblikovanje;ilustracija;slikanje;
    Keywords[sr]=Гимп;обрада фотографија;графика;дизајн;илустрација;цртање;obrada fotografija;grafika;dizajn;ilustracija;crtanje;GIMP;PhotoGIMP;graphic;design;illustration;painting;
    Keywords[sv]=GIMP;PhotoGIMP;grafik;design;illustrera;målning;rita;
    Keywords[tr]=GIMP;PhotoGIMP;grafik;tasarım;örnekleme;boyama;illüstrasyon;resimleme;
    Keywords[uk]=GIMP;PhotoGIMP;graphic;design;illustration;painting;гімп;ґімп;графіка;дизайн;ілюстрації;малювання;
    Keywords[zh_CN]=GIMP;PhotoGIMP;图形;设计;绘画;graphic;design;illustration;painting;
    StartupNotify=true
  '';
}
